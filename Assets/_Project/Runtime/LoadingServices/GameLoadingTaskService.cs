...
namespace _Project.Runtime.LoadingServices
{
    public class GameLoadingTaskService : BaseLoadingTaskService
    {
        ...
        public GameLoadingTaskService(SceneLoader sceneLoader, IViewPoolsService poolsService, ViewsContainer viewsContainer, HudViewProvider hudViewProvider, BackgroundViewProvider backgroundViewProvider, BGMViewProvider bgmViewProvider) : base(sceneLoader)
        {
