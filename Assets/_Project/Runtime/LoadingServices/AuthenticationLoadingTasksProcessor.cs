...
{
    public class AuthenticationLoadingTasksProcessor : BaseLoadingTasksProcessor
    {
        private readonly SceneAssetProvider _assetProvider;

        public AuthenticationLoadingTasksProcessor(SceneLoader sceneLoader, SceneAssetProvider assetProvider)
            : base(sceneLoader)
        {
            _assetProvider = assetProvider;
        }

        protected override int SceneIndex => Scenes.Authentication;
